...
在 GSM8K eval 上，当前预实验中观测到的最好 accuracy 分别是：Base model 36.5%、GRPO 47.0%、无教师 F2F 48.0%、Teacher-Guided F2F 50.0%。但只看最好值还不够：无教师 F2F 虽然短暂提升，但后期会跌到 39.5%；Teacher-Guided F2F 在这个 pilot 对比中取得了最高 eval 分数，同时缓解了小模型无指导自纠偏的不稳定问题。
